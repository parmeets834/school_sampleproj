                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          Text("GEORGIA SCHOOL",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18),),
        ...
        onPressed: () {
          setState(() {
            list.add(UserModel(
                ...
                classname: "class: ${Random().nextInt(12).toString()}th ",
                rollno: "Roll No: ${Random().nextInt(15000).toString()}"));
          });
        },
