...
*/
  ...
  @override
  _StudentTimeTablePageState createState() =>
      _StudentTimeTablePageState();
}

class _StudentTimeTablePageState
    extends State<StudentTimeTablePage> {
  int selectedRow;
  int selectedColumn;
    ...
    home: Scaffold(
      ...
      body: StickyHeadersTable(
        ...
        columnsTitleBuilder: (i) => FlatButton(
          child: Text(widget.titleColumn[i]),color:Colors.blueGrey,textColor:Colors.white  ,
          onPressed: clearState,
        ),
        rowsTitleBuilder: (i) => InkWell(
          child: Container(
              color:Colors.transparent,
              child: Text(widget.titleRow[i],style: TextStyle(color: Colors.white),)),
          onTap: clearState,
        ),
        ...
        legendCell: FlatButton(
          child: Text('-'),
          onPressed: clearState,color:Colors.blueGrey,textColor:Colors.white,
        ),
      ),
    ),
  );
